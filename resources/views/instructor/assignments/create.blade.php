...
<head>
  ...
  <title>DataSensei — Create Assignment</title>
  ...
  <div class="ds-shell">
    ...
    <main class="ds-main">
      ...
      <div class="wrap">
        <div class="top-row">
          <div>
            <div class="page-kicker">{{ $isEdit ? 'Edit Assignment' : 'Create Assignment' }}</div>
            <h1 class="page-title">{{ $isEdit ? 'Update assignment' : 'Assign a topic version' }}</h1>
