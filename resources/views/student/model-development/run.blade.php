...
<meta http-equiv="refresh" content="0;url={{ route('student.model-development.index') }}"><title>Legacy Model Run — DataSensei</title>    @include('partials.page-head', ['pageTitle' => 'Legacy Model Run', 'pageDescription' => 'Build, evaluate, and save a real machine-learning model in ten guided steps.'])
