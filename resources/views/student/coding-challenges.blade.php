...
<head>
  ...
  <title>Coding Challenges — DataSensei</title>
<style>
    /* Coding challenge path list. Colours, type and radius come from partials.design-system;
       challenges.blade.php uses the same rules. */
...
<div class="page-layout-wrapper">
  ...
  <div class="page-challenges-main">
    ...
    <header class="page-challenges-header">
      <h1 class="ds-page-title">Coding Challenges</h1>
      <p class="page-challenges-hero-subtitle">Choose a path that matches your current experience level. Some modules do not include coding challenges due to the theoretical nature of their topics.</p>
      <p class="page-challenges-institution-note">
        Coding paths now unlock through progression. Complete the previous difficulty to move forward; exceptional speed, accuracy, and low attempts can unlock the next-next difficulty early.
      </p>
    </header>
    ...
    <div class="page-challenges-grid">
      ...
      @foreach($categories as $cat)
        ...
        @else
          <a href="{{ route('challenges.coding.map', $cat->slug) }}" class="page-challenges-card {{ $isBonusUnlocked ? 'is-bonus' : '' }}">
            @if($isBonusUnlocked)
