            ...
            <div class="challenge-map-node state-{{ $state }}"
              ...
              <div class="challenge-map-node-info">
                ...
                @if($state === 'completed')
                  ...
                  <a href="{{ route('coding-challenges.quiz', ['slug' => $slug, 'challenge' => $ch->id]) }}" class="challenge-map-btn-retry">
                ...
                @elseif($state === 'failed')
                  ...
                  <a href="{{ route('coding-challenges.quiz', ['slug' => $slug, 'challenge' => $ch->id]) }}" class="challenge-map-btn-start">
                    <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                    </svg>
                    Try Again
