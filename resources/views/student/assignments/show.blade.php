...
<head>
  ...
  <title>DataSensei — Assignment Overview</title>
  ...
  <div class="ds-shell">
    ...
    <main class="ds-main">
      ...
      <div class="wrap">
        <div class="top-row">
          <div>
            <div class="page-kicker">Assignment Overview</div>
        ...
        <section class="card card-pad">
          ...
          <p class="muted" style="line-height:1.7;margin-bottom:18px">{{ $assignment->instructions ?: $assignment->libraryItem->instructions ?: 'Answer all items before submitting.' }}</p>
          <p class="muted" style="margin-bottom:18px">Due: <strong>{{ $assignment->due_at ? $assignment->due_at->format('M d, Y h:i A') : 'No due date' }}</strong></p>
