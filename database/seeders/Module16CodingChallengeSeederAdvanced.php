...
class Module16CodingChallengeSeederAdvanced extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 16 — Multivariate Analysis (Advanced) [Coding]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Multivariate Analysis at the Advanced level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
        ...
        $questionDefs = [
            [
                'order_index' => 1,
                'problem_description' => '### Module 16: Multivariate Analysis
### Difficulty: Advanced
### Task 1: Count words
