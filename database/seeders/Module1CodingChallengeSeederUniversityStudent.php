...
class Module1CodingChallengeSeederUniversityStudent extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 1 — Basics of Python Programming (University Student) [Coding]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Basics of Python Programming at the University Student level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
        ...
        $questionDefs = [
            [
                'order_index' => 1,
                'problem_description' => '### Module 1: Basics of Python Programming
...
7 -2', 'expected_output' => '-3', 'is_hidden' => true],
        ...
        $this->command->info('Module 1 Coding (University Student) seeded — 1 challenge, 50 questions, 200 test cases.');
    }
}
