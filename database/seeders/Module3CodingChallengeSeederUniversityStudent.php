...
class Module3CodingChallengeSeederUniversityStudent extends Seeder
{
    public function run(): void
    {
        ...
        $challenge = Challenge::create([
            ...
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Introduction to Data Science at the University Student level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
