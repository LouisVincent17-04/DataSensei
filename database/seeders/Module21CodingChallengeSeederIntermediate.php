...
class Module21CodingChallengeSeederIntermediate extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 21 — Machine Learning 2: Unsupervised Learning (Intermediate) [Coding]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Machine Learning 2: Unsupervised Learning at the Intermediate level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
