...
class Module22CodingChallengeSeederIntermediate extends Seeder
{
    public function run(): void
    {
        ...
        $challenge = Challenge::create([
            ...
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Big Data & Cloud Computing at the Intermediate level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
