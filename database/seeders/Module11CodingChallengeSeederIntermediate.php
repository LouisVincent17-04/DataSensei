...
class Module11CodingChallengeSeederIntermediate extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 11 — Introduction to Bayesian Data Analysis (Intermediate) [Coding]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Introduction to Bayesian Data Analysis at the Intermediate level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
