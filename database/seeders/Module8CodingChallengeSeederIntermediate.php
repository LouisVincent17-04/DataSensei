...
class Module8CodingChallengeSeederIntermediate extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 8 — Statistical Methods & Experimental Design (Intermediate) [Coding]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Statistical Methods & Experimental Design at the Intermediate level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
