...
class Module15ChallengeSeederAdvanced extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 15 — Data Visualization (Advanced) [MCQ]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item Advanced MCQ challenge for Data Visualization. Items include concepts, scenarios, debugging, interpretation, and decision-making.',
        ...
        $qaData = [
            [
                'q' => 'Item 1: In Data Visualization, which action best supports edge cases, assumptions, evaluation, and trade-offs when starting a new task involving problem framing?',
                'opts' => [
            ...
            [
                'q' => 'Item 2: A learner working on Data Visualization gets a result that looks correct. What should they do next at the Advanced level?',
                'opts' => [
            ...
            [
                'q' => 'Item 5: Which response shows the best Advanced practice when a method in Data Visualization fails on one test case?',
                'opts' => [
            ...
            [
                'q' => 'Item 9: When comparing two approaches in Data Visualization, what should a Advanced learner prioritize?',
                'opts' => [
            ...
            [
                'q' => 'Item 11: In Data Visualization, which action best supports edge cases, assumptions, evaluation, and trade-offs when starting a new task involving reproducibility?',
                'opts' => [
                    ['text' => 'Choose the most complex tool immediately', 'correct' => false],
                    ['text' => 'Ignore the data context and focus only on the final number', 'correct' => false],
                    ['text' => 'Define the goal, inputs, assumptions, and expected output before choosing a method', 'correct' => true],
            ...
            [
                'q' => 'Item 12: A learner working on Data Visualization gets a result that looks correct. What should they do next at the Advanced level?',
                'opts' => [
                    ['text' => 'Submit immediately without checking', 'correct' => false],
                    ['text' => 'Change the result until it looks impressive', 'correct' => false],
                    ['text' => 'Remove notes to make the work shorter', 'correct' => false],
            ...
            [
                'q' => 'Item 15: Which response shows the best Advanced practice when a method in Data Visualization fails on one test case?',
                'opts' => [
                    ['text' => 'Delete the failing case', 'correct' => false],
                    ['text' => 'Change the expected answer to match the wrong output', 'correct' => false],
                    ['text' => 'Inspect the failing input, trace the logic, and update the method without breaking passing cases', 'correct' => true],
            ...
            [
                'q' => 'Item 19: When comparing two approaches in Data Visualization, what should a Advanced learner prioritize?',
                'opts' => [
                    ['text' => 'Whichever approach has the fanciest name', 'correct' => false],
                    ['text' => 'Only the approach used first in class', 'correct' => false],
                    ['text' => 'Accuracy, assumptions, interpretability, cost, and fitness to the problem', 'correct' => true],
            ...
            [
                'q' => 'Item 21: In Data Visualization, which action best supports edge cases, assumptions, evaluation, and trade-offs when starting a new task involving problem framing?',
                'opts' => [
                    ['text' => 'Define the goal, inputs, assumptions, and expected output before choosing a method', 'correct' => true],
                    ['text' => 'Choose the most complex tool immediately', 'correct' => false],
                    ['text' => 'Ignore the data context and focus only on the final number', 'correct' => false],
            ...
            [
                'q' => 'Item 22: A learner working on Data Visualization gets a result that looks correct. What should they do next at the Advanced level?',
                'opts' => [
                    ['text' => 'Submit immediately without checking', 'correct' => false],
                    ['text' => 'Validate the result with examples, assumptions, and possible edge cases', 'correct' => true],
                    ['text' => 'Change the result until it looks impressive', 'correct' => false],
            ...
            [
                'q' => 'Item 25: Which response shows the best Advanced practice when a method in Data Visualization fails on one test case?',
                'opts' => [
                    ['text' => 'Inspect the failing input, trace the logic, and update the method without breaking passing cases', 'correct' => true],
                    ['text' => 'Delete the failing case', 'correct' => false],
                    ['text' => 'Change the expected answer to match the wrong output', 'correct' => false],
            ...
            [
                'q' => 'Item 29: When comparing two approaches in Data Visualization, what should a Advanced learner prioritize?',
                'opts' => [
                    ['text' => 'Accuracy, assumptions, interpretability, cost, and fitness to the problem', 'correct' => true],
                    ['text' => 'Whichever approach has the fanciest name', 'correct' => false],
                    ['text' => 'Only the approach used first in class', 'correct' => false],
            ...
            [
                'q' => 'Item 31: In Data Visualization, which action best supports edge cases, assumptions, evaluation, and trade-offs when starting a new task involving reproducibility?',
                'opts' => [
                    ['text' => 'Choose the most complex tool immediately', 'correct' => false],
                    ['text' => 'Ignore the data context and focus only on the final number', 'correct' => false],
                    ['text' => 'Define the goal, inputs, assumptions, and expected output before choosing a method', 'correct' => true],
            ...
            [
                'q' => 'Item 32: A learner working on Data Visualization gets a result that looks correct. What should they do next at the Advanced level?',
                'opts' => [
                    ['text' => 'Submit immediately without checking', 'correct' => false],
                    ['text' => 'Change the result until it looks impressive', 'correct' => false],
                    ['text' => 'Remove notes to make the work shorter', 'correct' => false],
            ...
            [
                'q' => 'Item 35: Which response shows the best Advanced practice when a method in Data Visualization fails on one test case?',
                'opts' => [
                    ['text' => 'Delete the failing case', 'correct' => false],
                    ['text' => 'Change the expected answer to match the wrong output', 'correct' => false],
                    ['text' => 'Inspect the failing input, trace the logic, and update the method without breaking passing cases', 'correct' => true],
            ...
            [
                'q' => 'Item 39: When comparing two approaches in Data Visualization, what should a Advanced learner prioritize?',
                'opts' => [
                    ['text' => 'Whichever approach has the fanciest name', 'correct' => false],
                    ['text' => 'Only the approach used first in class', 'correct' => false],
                    ['text' => 'Accuracy, assumptions, interpretability, cost, and fitness to the problem', 'correct' => true],
            ...
            [
                'q' => 'Item 41: In Data Visualization, which action best supports edge cases, assumptions, evaluation, and trade-offs when starting a new task involving problem framing?',
                'opts' => [
                    ['text' => 'Define the goal, inputs, assumptions, and expected output before choosing a method', 'correct' => true],
                    ['text' => 'Choose the most complex tool immediately', 'correct' => false],
                    ['text' => 'Ignore the data context and focus only on the final number', 'correct' => false],
            ...
            [
                'q' => 'Item 42: A learner working on Data Visualization gets a result that looks correct. What should they do next at the Advanced level?',
                'opts' => [
                    ['text' => 'Submit immediately without checking', 'correct' => false],
                    ['text' => 'Validate the result with examples, assumptions, and possible edge cases', 'correct' => true],
                    ['text' => 'Change the result until it looks impressive', 'correct' => false],
            ...
            [
                'q' => 'Item 45: Which response shows the best Advanced practice when a method in Data Visualization fails on one test case?',
                'opts' => [
                    ['text' => 'Inspect the failing input, trace the logic, and update the method without breaking passing cases', 'correct' => true],
                    ['text' => 'Delete the failing case', 'correct' => false],
                    ['text' => 'Change the expected answer to match the wrong output', 'correct' => false],
            ...
            [
                'q' => 'Item 49: When comparing two approaches in Data Visualization, what should a Advanced learner prioritize?',
                'opts' => [
                    ['text' => 'Accuracy, assumptions, interpretability, cost, and fitness to the problem', 'correct' => true],
                    ['text' => 'Whichever approach has the fanciest name', 'correct' => false],
                    ['text' => 'Only the approach used first in class', 'correct' => false],
        ...
        $this->command->info('Module 15 MCQ (Advanced) seeded — 1 challenge, 50 questions, 200 options.');
    }
}
