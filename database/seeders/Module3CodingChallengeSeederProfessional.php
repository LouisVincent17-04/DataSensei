...
class Module3CodingChallengeSeederProfessional extends Seeder
{
    public function run(): void
    {
        ...
        $challenge = Challenge::create([
            ...
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Introduction to Data Science at the Professional level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
        ...
        $questionDefs = [
            [
                'order_index' => 1,
                'problem_description' => '### Module 3: Introduction to Data Science
...
',
        ...
        $this->command->info('Module 3 Coding (Professional) seeded — 1 challenge, 50 questions, 200 test cases.');
    }
}
