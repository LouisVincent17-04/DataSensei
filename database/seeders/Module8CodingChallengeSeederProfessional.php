...
class Module8CodingChallengeSeederProfessional extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 8 — Statistical Methods & Experimental Design (Professional) [Coding]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Statistical Methods & Experimental Design at the Professional level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
...
',
        ...
        $this->command->info('Module 8 Coding (Professional) seeded — 1 challenge, 50 questions, 200 test cases.');
    }
}
