...
class Module10CodingChallengeSeederUniversityStudent extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 10 — Database Management for Data Science (University Student) [Coding]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Database Management for Data Science at the University Student level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
