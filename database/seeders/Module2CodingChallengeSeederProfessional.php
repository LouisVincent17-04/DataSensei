...
class Module2CodingChallengeSeederProfessional extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 2 — Basics of Statistics (Professional) [Coding]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Basics of Statistics at the Professional level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
...
',
        ...
        $this->command->info('Module 2 Coding (Professional) seeded — 1 challenge, 50 questions, 200 test cases.');
    }
}
