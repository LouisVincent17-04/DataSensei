...
class Module2CodingChallengeSeederNewbie extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 2 — Basics of Statistics (Newbie) [Coding]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Basics of Statistics at the Newbie level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
