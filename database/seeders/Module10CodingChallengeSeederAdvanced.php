...
class Module10CodingChallengeSeederAdvanced extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 10 — Database Management for Data Science (Advanced) [Coding]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Database Management for Data Science at the Advanced level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
