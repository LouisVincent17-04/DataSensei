...
class Module13CodingChallengeSeederUniversityStudent extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Creating Module 13 — Introduction to Optimization Techniques (University Student) [Coding]...');

        $challenge = Challenge::create([
            'challenge_category_id' => $category->id,
            'title' => $title,
            'description' => 'A detailed 50-item coding challenge for Introduction to Optimization Techniques at the University Student level. Each item includes visible and hidden tests, standard input parsing, and exact output requirements.',
